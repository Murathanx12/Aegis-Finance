...
**T2 ✅ done (2026-06-14)** → **T3 next** (SOS recession flag, offline-verifiable) → **T1** (LPPLS descriptive flag, largest; D1+D2 resolved). Then the existing §P1 #6 lane framework (now unblocked: correlated lanes are reflected in the reported N_eff view). Follow-up research pass owed on the **unverified** items (Section 4 data-ToS, Section 5 real-time signals, CSCV/slippage mechanics) before any of those ship as asserted.
