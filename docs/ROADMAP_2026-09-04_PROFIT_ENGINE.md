...
| G growth book (amendment 2026-09-07) | OPEN — `ROADMAP_2026-09-07_GROWTH_BOOK_AMENDMENT.md`: product ruler = after-cost terminal wealth at a declared drawdown budget, β reported; dev 1999-2015 / sealed 2016-2024 opened once; genomes from the published growth recipes + our selectors; NN = distribution forecaster for sizing vs Moreira-Muir baseline; hack4 forward contract. Prompt `CONTINUATION_2026-09-07b_GROWTH_BOOK_OPUS_PROMPT.md` | — |
