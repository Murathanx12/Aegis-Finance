...
| B7 era replay v2 | **§1-§2 DONE 2026-09-06 — the decide step ran, and all four arms are NEGATIVE** | `BUILD_CONTINUATION_2026-09-06.md` §2b. **192 windows** of 2016-01..2019-12 (the whole era, not a sample), gpt-5-nano rewriter at `reasoning_effort="minimal"`, DeepSeek decider at T=0, **rank graded only**, benchmarked against the EW basket of the same 8 anonymised names in the same month, 10 bps, $3m/day + $5 floors. mean IC: fantasy-nodiary **−0.031**, fantasy-diary −0.026, realanon-nodiary −0.043, realanon-diary −0.053; net top−EW **−0.39 / −0.13 / −0.31 / −0.52 %**. Family size 4, **family-max p 0.729, nothing survives BH at 0.05**, best-arm DSR 0.0205; nulls 1-3 all p > 0.72 and null 3 (same-day paired, the primary) is −0.449%, t −0.678. **Memorisation canary CLEAN: 0 of 192 exact-year hits against a 0.25 chance rate, 0% company-named** — and when it guessed it said 2023/2024, its own training era. The fantasy-vs-real-anon contrast is unanswerable because neither arm is above zero. Confound found and recorded: the rewriter preserved every magnitude in only **195 of 382** bundles. §3 (stress exams) and §4 (live bridge) not started. Cost **$0.3175**. Receipts `L10_era_replay_v2_run01.json`, `L10_era_replay_v2_pilot.json`, `L10_era_replay_windows.json` |
