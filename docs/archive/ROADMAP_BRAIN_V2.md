...
| R13 | Allocation program phase 2 — REGIME-ANALOG phase 2 (Bayesian belief updating + the evidence-weight schema; descriptor expansion candidates: breadth, sector leadership, dollar; still descriptive, never arms). Admissible-not-queued (each = NEW deflated registration, SAME registry — parallel ledgers refused, AI_PANEL_2026-07-28B §3.6): 8-K matched-control successor; cross-sectional SELL/deterioration-trigger family (10b5-1 2023 break binds insider-sales designs); specific timed-allocation hypotheses (post-hoc-repair provenance binds); **capital-flows family** (the round's one genuinely new direction — design note + PIT-data feasibility audit first, AI_PANEL_2026-07-28B §3.3) | post-freeze |
