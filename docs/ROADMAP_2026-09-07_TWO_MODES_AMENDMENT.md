...
|---|---|---|---|---|
| hack1 | SPY control + survival layer | n/a; manage-only | n/a | the benchmark is a competitor for capital, not a default |
| hack2 | **EVENT / day book** (Murat: "day trading with one") | 1-3 sessions / 0 / `EXPLICIT_EVENT_STRATEGY_EXIT` + `DEADLINE`; declared as an event strategy so min hold 0 is a choice, not a default | judged at 40 events, 24 expected to lose | today's EVENT defaults become an *explicit* contract; PEAD/surprise×reaction books feed it once E3 runs |
...
|---|---|---|
| **X hygiene** | OPEN 2026-09-07 — 11 rows, none started | see §2 X; owners in the handoff |
