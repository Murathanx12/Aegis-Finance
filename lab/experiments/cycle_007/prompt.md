# Aegis Finance - Autonomous R&D Lab - Cycle 7
Time: 2026-04-11T21:56:01.132649
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_007: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_007/data_test --cycle 7`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_007/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_007: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.62,
      "direction_correct": false,
      "absolute_error_pct": 16.34
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.3,
      "direction_correct": true,
      "absolute_error_pct": 4.29
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 4.09,
      "direction_correct": true,
      "absolute_error_pct": 0.65
    }
  ],
  "summary": {
    "n_tests": 3,
    "direction_accuracy_pct": 66.7,
    "mean_absolute_error_pct": 7.09
  }
}
```
...
{
  "cycle": 7,
  "timestamp": "2026-04-11T21:55:35.809133",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7413.72,
    "mean_price": 7523.2,
    "p5": 5583.41,
    "p95": 9820.33,
    "prob_positive": 68.8,
    "prob_20pct_crash": 3.8,
    "expected_annual_return_pct": 10.36
  },
  "3y": {
    "median_price": 8857.47,
    "mean_price": 9207.2,
    "p5": 5464.91,
    "p95": 14221.72,
    "prob_positive": 81.6,
  ...
  "5y": {
    "median_price": 10565.18,
    "mean_price": 11315.95,
    "p5": 5678.88,
    "p95": 19433.64,
    "prob_positive": 88.0,
    "prob_20pct_crash": 3.9,
    "expected_annual_return_pct": 10.67
  },
  "quality_check": {
    "theoretical_1y_drift": 0.10072,
    "actual_1y_mean_log_return": 0.08536,
    "drift_error_pct": 15.25,
    "variance_ratio": 0.992
  }
}
```
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "p75": 360.21,
      "p95": 475.88,
      "prob_above_current": 71.7,
      "prob_20pct_drawdown": 8.6,
      "expected_return_pct": 21.33,
      "median_return_pct": 17.82
    },
    "mc_quality": {
      "drift_error_pct": 23.92,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "p75": 335.51,
      "p95": 532.84,
      "prob_above_current": 67.4,
      "prob_20pct_drawdown": 17.6,
      "expected_return_pct": 40.85,
      "median_return_pct": 23.88
    },
    "mc_quality": {
      "drift_error_pct": 38.13,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "p75": 198.45,
      "p95": 242.89,
      "prob_above_current": 70.5,
      "prob_20pct_drawdown": 7.3,
      "expected_return_pct": 14.32,
      "median_return_pct": 10.84
    },
    "mc_quality": {
      "drift_error_pct": 26.04,
      "drift_accurate": false
    },
    "statistics": {
