# Aegis Finance - Autonomous R&D Lab - Cycle 6
Time: 2026-04-11T21:45:23.806913
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_006: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_006/data_test --cycle 6`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_006/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_006: <summary>"
  ...
  "tests": [
    {
      ...
      "absolute_error_pct": 16.24
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 4.19,
      "direction_correct": true,
      "absolute_error_pct": 3.41
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 4.26,
      "direction_correct": true,
      "absolute_error_pct": 0.82
    }
  ],
  "summary": {
    "n_tests": 3,
    "direction_accuracy_pct": 66.7,
    "mean_absolute_error_pct": 6.82
  }
}
```
...
{
  "cycle": 6,
  "timestamp": "2026-04-11T21:44:57.695451",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7407.46,
    "mean_price": 7527.03,
    "p5": 5634.51,
    "p95": 9732.54,
    "prob_positive": 68.9,
    "prob_20pct_crash": 3.2,
    "expected_annual_return_pct": 10.42
  },
  "3y": {
    "median_price": 8849.13,
    "mean_price": 9199.05,
    "p5": 5470.13,
    "p95": 14054.77,
    "prob_positive": 81.1,
  ...
  "5y": {
    "median_price": 10510.08,
    "mean_price": 11284.14,
    "p5": 5613.39,
    "p95": 19803.39,
    "prob_positive": 87.1,
    "prob_20pct_crash": 4.2,
    "expected_annual_return_pct": 10.61
  },
  "quality_check": {
    "theoretical_1y_drift": 0.10072,
    "actual_1y_mean_log_return": 0.08645,
    "drift_error_pct": 14.17,
    "variance_ratio": 0.951
  }
}
```
...
```json
{
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "p95": 573.03,
      "prob_above_current": 71.8,
      "prob_20pct_drawdown": 15.1,
      "expected_return_pct": 47.97,
      "median_return_pct": 30.11
    },
    "mc_quality": {
      "drift_error_pct": 26.09,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "p75": 201.07,
      "p95": 248.44,
      "prob_above_current": 70.2,
      "prob_20pct_drawdown": 7.3,
      "expected_return_pct": 15.47,
      "median_return_pct": 12.32
    },
    "mc_quality": {
      "drift_error_pct": 20.29,
      "drift_accurate": false
    },
    "statistics": {
