# Aegis Finance — R&D Cycle 66 (DEEP_AUDIT)
...
```json
{
  "vix_term_structure": {
    "values": {
      ...
      "VIX9D": 16.040000915527344
    },
    "vix_vix3m_ratio": 0.871,
    "contango": true,
    "backwardation": false,
    "structure": "normal_contango",
    "signal": "neutral",
    "interpretation": "Normal term structure: VIX (18.2) < VIX3M (20.9)",
    "vix_level": "normal",
    "vix9d_vix_ratio": 0.883
  },
  "options_SPY": {
    "iv_skew": 1.418,
    "put_call_ratio": 1.834,
    "iv_rank": 52.7,
    "signal_score": -0.1,
...
{
  "cycle": 66,
  "timestamp": "2026-04-17T03:06:40.734907",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "current_price": 7031.419921875,
  "final_mean": 9872.824634997785,
  "final_median": 9004.688741355825,
  "final_p05": 3959.372562579774,
  "final_p10": 4753.891796862961,
  "final_p25": 6546.8508531266725,
  "final_p75": 12254.487800168074,
  "final_p90": 16104.154017545901,
  "final_p95": 18931.948280476692,
  "total_return_pct": 40.41011267557884,
  "annual_return_pct": 7.023630097307976,
  "crash_prob_1y": 25.040000000000003,
  "crash_prob_5y": 81.74,
  "cvar_95_pct": -54.25935064143278,
  "max_dd_pct": -30.76244969577652,
  "max_drawdown_pct": 30.76244969577652
}
```
...
```json
{
  "NVDA": {
    "ticker": "NVDA",
    "current_price": 198.26100158691406,
    "mc_median_5y": 64.8423326590583,
    "mc_p10_5y": -57.80021549366896,
    "mc_p90_5y": 300.0,
    "garch_vol": 37.41452153035112,
    "garch_nu": 8.0,
    "crash_prob_3m": 7.99,
  ...
  "V": {
    "ticker": "V",
    "current_price": 315.9649963378906,
    "mc_median_5y": 47.97937506705983,
    "mc_p10_5y": -17.943168943976183,
    "mc_p90_5y": 159.26771460019432,
    "garch_vol": 21.925127033841836,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.08,
    "signal_action": "Buy",
    "signal_score": 0.202,
  ...
  "MA": {
    "ticker": "MA",
    "current_price": 520.614990234375,
    "mc_median_5y": 46.41946915344424,
    "mc_p10_5y": -19.925215503991055,
    "mc_p90_5y": 160.45708016452198,
    "garch_vol": 23.36759396716697,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.21,
    "signal_action": "Buy",
    "signal_score": 0.217,
  ...
  "PG": {
    ...
    "mc_median_5y": 20.820867144579292,
    "mc_p10_5y": -30.505332962473698,
    "mc_p90_5y": 101.53637649719403,
    "garch_vol": 19.369336928850426,
    "garch_nu"
... [truncated]
```
...
1. Write experiment report to: lab/experiments/cycle_066/experiment_report.json
   {
     "cycle": 66,
...
2. Commit: `git add -A && git commit -m "Lab cycle_066: <summary>"`
