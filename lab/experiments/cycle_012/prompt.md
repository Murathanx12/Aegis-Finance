# Aegis Finance - Autonomous R&D Lab - Cycle 12
Time: 2026-04-11T22:46:47.623667
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_012: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_012/data_test --cycle 12`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_012/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_012: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.34,
      "direction_correct": false,
      "absolute_error_pct": 16.05
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.25,
      "direction_correct": true,
      "absolute_error_pct": 4.35
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 3.75,
      "direction_correct": true,
      "absolute_error_pct": 0.31
    }
  ],
  "summary": {
    "n_tests": 3,
...
{
  "cycle": 12,
  "timestamp": "2026-04-11T22:46:22.824529",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7390.28,
    "mean_price": 7524.61,
    "p5": 5659.36,
    "p95": 9824.57,
    "prob_positive": 68.3,
    "prob_20pct_crash": 3.0,
    "expected_annual_return_pct": 10.38
  },
  "3y": {
    "median_price": 8797.26,
    "mean_price": 9174.39,
    "p5": 5459.67,
    "p95": 13928.41,
    "prob_positive": 82.1,
    "prob_20pct_crash": 5.0,
    "expected_annual_return_pct": 10.41
  },
  "5y": {
    "median_price": 10481.28,
    "mean_price": 11249.11,
    "p5": 5579.47,
    "p95": 19663.26,
    "prob_positive": 86.9,
  ...
  "quality_check": {
    ...
    "actual_1y_mean_log_return": 0.08622,
    "drift_error_pct": 14.4,
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "p75": 363.84,
      "p95": 483.18,
      "prob_above_current": 70.7,
      "prob_20pct_drawdown": 8.7,
      "expected_return_pct": 20.72,
      "median_return_pct": 16.09
    },
    "mc_quality": {
      "drift_error_pct": 26.92,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "prob_20pct_drawdown": 16.8,
      "expected_return_pct": 45.87,
      "median_return_pct": 27.62
    },
    "mc_quality": {
      "drift_error_pct": 30.42,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "prob_20pct_drawdown": 6.7,
      "expected_return_pct": 15.26,
      "median_return_pct": 11.32
    },
    "mc_quality": {
      "drift_error_pct": 21.75,
      "drift_accurate": false
    },
    "statistics": {
