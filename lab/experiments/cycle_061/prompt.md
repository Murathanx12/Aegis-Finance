# Aegis Finance — R&D Cycle 61 (BUILD)
...
{
  "AAPL": {
    "error": "'charmap' codec can't encode character '\\u03b2' in position 24: character maps to <undefined>"
  },
  "JPM": {
    "error": "'charmap' codec can't encode character '\\u03b2' in position 23: character maps to <undefined>"
  },
  "XOM": {
    "error": "'charmap' codec can't encode character '\\u03b2' in position 23: character maps to <undefined>"
  }
...
```json
{
  "vix_term_structure": {
    "values": {
      ...
      "VIX3M": 21.350000381469727,
      "VIX9D": 16.940000534057617
    },
    "vix_vix3m_ratio": 0.878,
    "contango": true,
    "backwardation": false,
    "structure": "normal_contango",
    "signal": "neutral",
    "interpretation": "Normal term structure: VIX (18.7) < VIX3M (21.4)",
    "vix_level": "normal",
    "vix9d_vix_ratio": 0.904
  },
  "options_SPY": {
    "iv_skew": 1.432,
    "put_call_ratio": 1.906,
    "iv_rank": 55.4,
    "signal_score": -0.1,
...
{
  "cycle": 61,
  "timestamp": "2026-04-17T01:36:42.875234",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "current_price": 7031.0,
  "final_mean": 9884.429042230824,
  "final_median": 8975.308595955103,
  "final_p05": 3925.780053974475,
  "final_p10": 4788.696242594059,
  "final_p25": 6488.186858219968,
  "final_p75": 12317.565076659843,
  "final_p90": 16110.917528052276,
  "final_p95": 19163.737368355745,
  "total_return_pct": 40.58354490443499,
  "annual_return_pct": 7.0500558047998485,
  "crash_prob_1y": 25.0,
  "crash_prob_5y": 81.23,
  "cvar_95_pct": -54.66515622307554,
  "max_dd_pct": -30.693854004631078,
  "max_drawdown_pct": 30.693854004631078
}
```
...
```json
{
  "HD": {
    "ticker": "HD",
    "current_price": 337.4700012207031,
    "mc_median_5y": 26.090383533126314,
    "mc_p10_5y": -37.68439408641281,
    "mc_p90_5y": 144.02063256122665,
    "garch_vol": 25.555774867436288,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.83,
    "signal_action": "Hold",
    "signal_score": 0.031,
  ...
  "META": {
    "ticker": "META",
    "current_price": 674.280029296875,
    "mc_median_5y": 50.30847401779148,
    "mc_p10_5y": -49.81110626630261,
    "mc_p90_5y": 300.0,
    "garch_vol": 40.440544200386796,
    "garch_nu": 8.0,
    "crash_prob_3m": 5.84,
    "signal_action": "Buy",
    "signal_score": 0.384,
  ...
  "TSLA": {
    "ticker": "TSLA",
    "current_price": 387.96990966796875,
    "mc_median_5y": -14.350137456145118,
    "mc_p10_5y": -84.53107350428384,
    "mc_p90_5y": 279.701290003655,
    "garch_vol": 48.372401302935494,
    "garch_nu": 8.0,
    "crash_prob_3m": 7.99,
    "signal_action": "Hold",
    "signal_score": 0.033,
  ...
  "XOM": {
    "ticker": "XOM",
    "current_price": 152.5299072265625,
    "mc_median_5y": 52.80382670903079,
    "mc_p10_5y": -21.682269068462247,
    "mc_p90_5y": 193.91315501589332,
    "garch_vol": 29.462417037369143,
...
```json
{
  "turbulence_current": 2.0668,
  "turbulence_percentile": 29.9,
...
Cycle 57: Bug fixes (4) + liquidity-adjusted position sizing in portfolio optimizer (improved)
...
1. Write experiment report to: lab/experiments/cycle_061/experiment_report.json
   {
     "cycle": 61,
     "cycle_type": "BUILD",
...
2. Commit: `git add -A && git commit -m "Lab cycle_061: <summary>"`
