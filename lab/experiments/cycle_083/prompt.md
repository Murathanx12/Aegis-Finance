# Aegis Finance — R&D Cycle 83 (INTEGRATE)
...
{
  "cycle": 83,
  "timestamp": "2026-04-17T09:26:10.580027",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "final_mean": 9886.708499128958,
  "final_median": 8949.290036854476,
  "final_p05": 3975.2811506236785,
  "final_p10": 4812.144614809957,
  "final_p25": 6525.2191933941795,
  "final_p75": 12334.7772662855,
  "final_p90": 16070.860968946226,
  "final_p95": 19040.313851349765,
  "total_return_pct": 40.41067534301317,
  "annual_return_pct": 7.023715872632397,
  "crash_prob_1y": 25.840000000000003,
  "crash_prob_5y": 82.21000000000001,
  "cvar_95_pct": -53.581759348726486,
  "max_dd_pct": -30.754297251415956,
  "max_drawdown_pct": 30.754297251415956
}
```
...
```json
{
  "HD": {
    ...
    "mc_median_5y": 26.197811217386846,
    "mc_p10_5y": -38.06295100154028,
    "mc_p90_5y": 146.8698373908709,
    "garch_vol": 25.560955140790387,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.83,
    "signal_action": "Hold",
    "signal_score": 0.014,
  ...
  "PG": {
    ...
    "mc_median_5y": 20.300565685717608,
    "mc_p10_5y": -30.550172356605408,
    "mc_p90_5y": 102.071208350063,
    "garch_vol": 19.367608228172045,
    "garch_nu": 8.0,
    "crash_prob_3m": 2.15,
    "signal_action": "Hold",
    "signal_score": 0.075,
  ...
  "NVDA": {
    "ticker": "NVDA",
    "current_price": 198.35000610351562,
    "mc_median_5y": 62.86778052887634,
    "mc_p10_5y": -58.9482229302952,
    "mc_p90_5y": 300.0,
    "garch_vol": 37.450150930738786,
    "garch_nu": 8.0,
    "crash_prob_3m": 7.99,
  ...
  "ABBV": {
    ...
    "mc_median_5y": 62.249707558898336,
    "mc_p10_5y": -12.403056551823266,
    "mc_p90_5y": 198.26923586739986,
    "garch_vol": 22.42888380235038,
    "g
... [truncated]
```
...
```json
{
  "turbulence_current": 2.7421,
  "turbulence_percentile": 39.9,
...
Cycle 82: Cross-Asset Macro Regime Monitor — Bloomberg MAC3-style growth×inflation quadrant, risk-on/off score, cross-asset correl (improved)

## When done

1. Write experiment report to: lab/experiments/cycle_083/experiment_report.json
   {
     "cycle": 83,
...
2. Commit: `git add -A && git commit -m "Lab cycle_083: <summary>"`
