# Aegis Finance — R&D Cycle 67 (BUILD)
...
```json
{
  "vix_term_structure": {
    "values": {
      ...
      "VIX3M": 20.75,
      "VIX9D": 15.920000076293945
    },
    "vix_vix3m_ratio": 0.869,
    "contango": true,
    "backwardation": false,
    "structure": "normal_contango",
    "signal": "neutral",
    "interpretation": "Normal term structure: VIX (18.0) < VIX3M (20.8)",
    "vix_level": "normal",
    "vix9d_vix_ratio": 0.882
  },
  "options_SPY": {
    "iv_skew": 1.409,
    "put_call_ratio": 1.774,
    "iv_rank": 54.8,
    "signal_score": -0.1,
...
{
  "cycle": 67,
  "timestamp": "2026-04-17T03:31:36.429851",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "current_price": 7034.85986328125,
  "final_mean": 9875.336566878777,
  "final_median": 9009.171449969228,
  "final_p05": 3921.543171930978,
  "final_p10": 4752.708738671119,
  "final_p25": 6503.350831971903,
  "final_p75": 12375.431240643304,
  "final_p90": 16045.434160849927,
  "final_p95": 18729.724706098445,
  "total_return_pct": 40.37716114891665,
  "annual_return_pct": 7.018606352181478,
  "crash_prob_1y": 25.64,
  "crash_prob_5y": 81.89,
  "cvar_95_pct": -54.94592010312538,
  "max_dd_pct": -30.900817040155054,
  "max_drawdown_pct": 30.900817040155054
}
```
...
```json
{
  "NVDA": {
    "ticker": "NVDA",
    "current_price": 198.44000244140625,
    "mc_median_5y": 65.02256452846329,
    "mc_p10_5y": -57.248151762133894,
    "mc_p90_5y": 300.0,
    "garch_vol": 37.41284699521958,
    "garch_nu": 8.0,
    "crash_prob_3m": 7.99,
  ...
  "GOOGL": {
    "ticker": "GOOGL",
    "current_price": 335.35198974609375,
    "mc_median_5y": 55.57732085558362,
    "mc_p10_5y": -27.427660494394967,
    "mc_p90_5y": 220.60562280772146,
    "garch_vol": 28.930983282955157,
    "garch_nu": 8.0,
    "crash_prob_3m": 4.21,
    "signal_action": "Strong Buy",
    "signal_score": 0.566,
  ...
  "MA": {
    "ticker": "MA",
    "current_price": 520.760009765625,
    "mc_median_5y": 46.40140736801443,
    "mc_p10_5y": -18.600968486544613,
    "mc_p90_5y": 158.20409091963447,
    "garch_vol": 23.367731175910702,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.21,
    "signal_action": "Buy",
    "signal_score": 0.217,
  ...
  "BRK-B": {
    "ticker": "BRK-B",
    "current_price": 474.94000244140625,
    "mc_median_5y": 31.79821296324952,
    "mc_p10_5y": -15.929556204089735,
    "mc_p90_5y": 108.35895404943207,
    "garch_vol": 14.916
... [truncated]
```
...
1. Write experiment report to: lab/experiments/cycle_067/experiment_report.json
   {
     "cycle": 67,
     "cycle_type": "BUILD",
...
2. Commit: `git add -A && git commit -m "Lab cycle_067: <summary>"`
