# Aegis Finance — R&D Cycle 70 (BUILD)
...
{
  "cycle": 70,
  "timestamp": "2026-04-17T04:33:45.212354",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "final_mean": 9876.40177318737,
  "final_median": 8984.711046302284,
  "final_p05": 3985.7160502209085,
  "final_p10": 4839.019751619681,
  "final_p25": 6542.667543758827,
  "final_p75": 12146.755322183213,
  "final_p90": 16107.975423976139,
  "final_p95": 19165.13601352301,
  "total_return_pct": 40.26429959519364,
  "annual_return_pct": 7.001392480231083,
  "crash_prob_1y": 25.419999999999998,
  "crash_prob_5y": 81.64,
  "cvar_95_pct": -54.36451147082737,
  "max_dd_pct": -30.753736066339503,
  "max_drawdown_pct": 30.753736066339503
}
```
...
```json
{
  "GOOGL": {
    ...
    "mc_median_5y": 55.384786173335485,
    "mc_p10_5y": -28.60688893478569,
    "mc_p90_5y": 222.431453935328,
    "garch_vol": 28.942163241035214,
    "garch_nu": 8.0,
    "crash_prob_3m": 4.26,
  ...
  "V": {
    ...
    "mc_median_5y": 47.376228848204185,
    "mc_p10_5y": -16.815171785395865,
    "mc_p90_5y": 155.93961718162012,
    "garch_vol": 21.923070419108814,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.1,
    "signal_action": "Hold",
    "signal_score": 0.114,
  ...
  "PG": {
    ...
    "mc_median_5y": 20.604023658589377,
    "mc_p10_5y": -30.489634718927704,
    "mc_p90_5y": 102.84861765785757,
    "garch_vol": 19.36761584196433,
    "garch_nu": 8.0,
    "crash_prob_3m": 2.15,
    "signal_action": "Hold",
    "signal_score": 0.074,
  ...
  "BRK-B": {
    "ticker": "BRK-B",
    "current_price": 475.1199951171875,
    "mc_median_5y": 32.33481271746192,
    "mc_p10_5y": -15.1061195265219,
    "mc_p90_5y": 107.73933547730974,
    "garch_vol": 
... [truncated]
```
...
1. Write experiment report to: lab/experiments/cycle_070/experiment_report.json
   {
     "cycle": 70,
     "cycle_type": "BUILD",
...
2. Commit: `git add -A && git commit -m "Lab cycle_070: <summary>"`
