# Aegis Finance - Autonomous R&D Lab - Cycle 14
Time: 2026-04-11T23:08:39.034626
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_014: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_014/data_test --cycle 14`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_014/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_014: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.65,
      "direction_correct": false,
      "absolute_error_pct": 16.37
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.57,
      "direction_correct": true,
      "absolute_error_pct": 4.03
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 3.93,
      "direction_correct": true,
      "absolute_error_pct": 0.49
    }
  ],
  "summary": {
    "n_tests": 3,
    "direction_accuracy_pct": 66.7,
    "mean_absolute_error_pct": 6.96
  }
}
```
...
{
  "cycle": 14,
  "timestamp": "2026-04-11T23:08:13.614446",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7443.31,
    "mean_price": 7544.99,
    "p5": 5596.73,
    "p95": 9855.9,
    "prob_positive": 70.3,
    "prob_20pct_crash": 3.4,
    "expected_annual_return_pct": 10.68
  },
  "3y": {
    "median_price": 8849.98,
    "mean_price": 9264.13,
    "p5": 5471.28,
    "p95": 14423.0,
    "prob_positive": 82.1,
    "prob_20pct_crash": 4.8,
    "expected_annual_return_pct": 10.77
  },
  "5y": {
    "median_price": 10494.41,
    "mean_price": 11334.7,
    "p5": 5646.97,
    "p95": 19947.97,
    "prob_positive": 87.7,
  ...
  "quality_check": {
    ...
    "actual_1y_mean_log_return": 0.08543,
    "drift_error_pct": 15.18,
    "variance_ratio": 1.023
  }
}
```
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "prob_20pct_drawdown": 9.8,
      "expected_return_pct": 21.46,
      "median_return_pct": 15.83
    },
    "mc_quality": {
      "drift_error_pct": 24.2,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "p75": 336.23,
      "p95": 590.25,
      "prob_above_current": 67.3,
      "prob_20pct_drawdown": 17.5,
      "expected_return_pct": 46.36,
      "median_return_pct": 28.81
    },
    "mc_quality": {
      "drift_error_pct": 32.71,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "p75": 202.85,
      "p95": 250.56,
      "prob_above_current": 70.4,
      "prob_20pct_drawdown": 7.3,
      "expected_return_pct": 15.89,
      "median_return_pct": 13.49
    },
    "mc_quality": {
      "drift_error_pct": 18.11,
      "drift_accurate": false
    },
    "statistics": {
