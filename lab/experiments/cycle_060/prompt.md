...
```json
{
  "vix_term_structure": {
    "values": {
      ...
      "VIX3M": 20.81999969482422,
      "VIX9D": 16.700000762939453
    },
    ...
    "vix_level": "normal",
    "vix9d_vix_ratio": 0.91
  },
  "options_SPY": {
    "iv_skew": 1.328,
    "put_call_ratio": 1.058,
    "iv_rank": 21.7,
    "signal_score": -0.1,
...
{
  "cycle": 60,
  "timestamp": "2026-04-15T04:33:30.871623",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "current_price": 6967.3798828125,
  "final_mean": 9767.301750054974,
  "final_median": 8925.889942048001,
  "final_p05": 3977.9076489879076,
  "final_p10": 4844.789039116979,
  "final_p25": 6481.620973008066,
  "final_p75": 12033.356844943577,
  "final_p90": 15840.49535820607,
  "final_p95": 18705.63179945789,
  "total_return_pct": 40.18615195863611,
  "annual_return_pct": 6.989466751306983,
  "crash_prob_1y": 25.05,
  "crash_prob_5y": 82.31,
  "cvar_95_pct": -53.634206152596064,
  "max_dd_pct": -30.639159048153154,
  "max_drawdown_pct": 30.639159048153154
}
```
...
```json
{
  "V": {
    "ticker": "V",
    "current_price": 311.3699951171875,
    "mc_median_5y": 84.32597247807558,
    "mc_p10_5y": 5.074292859105745,
    "mc_p90_5y": 213.41374117494888,
    "garch_vol": 22.954573603464496,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.1,
    "signal_action": "Hold",
    "signal_score": 0.105,
  ...
  "ABBV": {
    "ticker": "ABBV",
    "current_price": 210.25999450683594,
    "mc_median_5y": 93.47516354696293,
    "mc_p10_5y": 4.886464363356802,
    "mc_p90_5y": 260.2408182341976,
    "garch_vol": 23.23959280564101,
    "garch_nu": 8.0,
    "crash_prob_3m": 2.08,
    "signal_action": "Buy",
    "signal_score": 0.413,
  ...
  "AMZN": {
    "ticker": "AMZN",
    "current_price": 249.02000427246094,
    "mc_median_5y": 37.48206640158691,
    "mc_p10_5y": -41.117370874662164,
    "mc_p90_5y": 203.44665264611538,
    "garch_vol": 31.631076798159054,
    "garch_nu": 8.0,
    "crash_prob_3m": 5.32,
    "signal_action": "Hold",
    "signal_score": 0.137,
  ...
  "HD": {
    "ticker": "HD",
    "current_price": 342.7099914550781,
    "mc_median_5y": 51.12260178643573,
    "mc_p10_5y": -25.305637889065512,
    "mc_p90_5y": 189.59341731950494,
    "garch_vol": 25.846992036107125,
    "g
... [truncated]
```
...
```json
{
  "turbulence_current": 6.7331,
  "turbulence_percentile": 75.7,
...
1. Experiment report: lab/experiments/cycle_060/experiment_report.json
   {
     "cycle": 60,
...
2. Commit: `git add -A && git commit -m "Lab cycle_060: <summary>"`
