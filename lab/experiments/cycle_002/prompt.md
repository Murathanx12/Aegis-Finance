# Aegis Finance - Autonomous R&D Lab - Cycle 2
Time: 2026-04-11T20:55:26.047850
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_002: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_002/data_test --cycle 2`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_002/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_002: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.38,
      "direction_correct": false,
      "absolute_error_pct": 16.09
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.49,
      "direction_correct": true,
      "absolute_error_pct": 4.1
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 4.16,
      "direction_correct": true,
      "absolute_error_pct": 0.72
    }
  ],
  "summary": {
    "n_tests": 3,
...
{
  "cycle": 2,
  "timestamp": "2026-04-11T20:55:00.297700",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  ...
  "3y": {
    "median_price": 8838.46,
    "mean_price": 9266.73,
    "p5": 5488.39,
    "p95": 14405.51,
    "prob_positive": 81.6,
    "prob_20pct_crash": 4.7,
    "expected_annual_return_pct": 10.78
  },
  "5y": {
    "median_price": 10444.81,
    "mean_price": 11243.84,
    "p5": 5576.1,
    "p95": 19493.57,
    "prob_positive": 86.8,
  ...
  "quality_check": {
    ...
    "actual_1y_mean_log_return": 0.08521,
    "drift_error_pct": 15.4,
    "variance_ratio": 1.008
  }
}
```
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "p75": 375.07,
      "p95": 490.33,
      "prob_above_current": 74.0,
      "prob_20pct_drawdown": 8.0,
      "expected_return_pct": 24.34,
      "median_return_pct": 19.85
    },
    "mc_quality": {
      "drift_error_pct": 12.51,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "p75": 340.58,
      "p95": 570.53,
      "prob_above_current": 69.9,
      "prob_20pct_drawdown": 15.2,
      "expected_return_pct": 47.63,
      "median_return_pct": 27.78
    },
    "mc_quality": {
      "drift_error_pct": 28.09,
      "drift_accurate": false
    },
    "statistics": {
