# Aegis Finance - Autonomous R&D Lab - Cycle 17
Time: 2026-04-11T23:38:54.004595
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_017: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_017/data_test --cycle 17`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_017/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_017: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.59,
      "direction_correct": false,
      "absolute_error_pct": 16.3
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.63,
      "direction_correct": true,
      "absolute_error_pct": 3.96
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 4.01,
      "direction_correct": true,
      "absolute_error_pct": 0.58
    }
  ],
  "summary": {
    "n_tests": 3,
    "direction_accuracy_pct": 66.7,
    "mean_absolute_error_pct": 6.95
  }
}
```
...
{
  "cycle": 17,
  "timestamp": "2026-04-11T23:38:29.325772",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7452.48,
    "mean_price": 7542.29,
    "p5": 5608.84,
    "p95": 9822.23,
    "prob_positive": 70.2,
    "prob_20pct_crash": 3.8,
    "expected_annual_return_pct": 10.64
  },
  "3y": {
    "median_price": 8802.28,
    "mean_price": 9217.62,
    "p5": 5465.67,
    "p95": 14349.67,
    "prob_positive": 81.0,
    "prob_20pct_crash": 4.9,
    "expected_annual_return_pct": 10.58
  },
  "5y": {
    "median_price": 10495.88,
    "mean_price": 11305.16,
    "p5": 5594.7,
    "p95": 19769.3,
    "prob_positive": 87.7,
  ...
  "quality_check": {
    ...
    "actual_1y_mean_log_return": 0.08836,
    "drift_error_pct": 12.28,
    "variance_ratio": 0.952
  }
}
```
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "p75": 368.26,
      "p95": 487.16,
      "prob_above_current": 71.6,
      "prob_20pct_drawdown": 8.3,
      "expected_return_pct": 22.22,
      "median_return_pct": 17.3
    },
    "mc_quality": {
      "drift_error_pct": 21.29,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "p75": 332.64,
      "p95": 549.22,
      "prob_above_current": 67.6,
      "prob_20pct_drawdown": 18.6,
      "expected_return_pct": 43.14,
      "median_return_pct": 24.69
    },
    "mc_quality": {
      "drift_error_pct": 38.12,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "p75": 200.78,
      "p95": 251.38,
      "prob_above_current": 69.1,
      "prob_20pct_drawdown": 8.1,
      "expected_return_pct": 15.12,
      "median_return_pct": 12.34
    },
    "mc_quality": {
      "drift_error_pct": 24.09,
      "drift_accurate": false
    },
    "statistics": {
