# Aegis Finance - Autonomous R&D Lab - Cycle 8
Time: 2026-04-11T22:08:39.171893
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_008: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_008/data_test --cycle 8`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_008/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_008: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.07,
      "direction_correct": false,
      "absolute_error_pct": 15.78
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.01,
      "direction_correct": true,
      "absolute_error_pct": 4.58
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 4.02,
      "direction_correct": true,
      "absolute_error_pct": 0.59
    }
  ],
  "summary": {
    "n_tests": 3,
    "direction_accuracy_pct": 66.7,
    "mean_absolute_error_pct": 6.98
  }
}
```
...
{
  "cycle": 8,
  "timestamp": "2026-04-11T22:08:14.342581",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7416.56,
    "mean_price": 7512.3,
    "p5": 5647.55,
    "p95": 9821.22,
    "prob_positive": 68.9,
    "prob_20pct_crash": 3.5,
    "expected_annual_return_pct": 10.2
  },
  "3y": {
    "median_price": 8845.26,
    "mean_price": 9237.85,
    "p5": 5547.59,
    "p95": 14192.02,
    "prob_positive": 82.2,
    "prob_20pct_crash": 4.5,
    "expected_annual_return_pct": 10.66
  },
  "5y": {
    "median_price": 10533.53,
    "mean_price": 11347.32,
    "p5": 5564.52,
    "p95": 19958.33,
    "prob_positive": 86.7,
    "prob_20pct_crash": 4.3,
    "expected_annual_return_pct": 10.73
  },
  "quality_check": {
    "theoretical_1y_drift": 0.10072,
    "actual_1y_mean_log_return": 0.08122,
    "drift_error_pct": 19.36,
    "variance_ratio": 1.003
  }
}
```
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "prob_20pct_drawdown": 8.6,
      "expected_return_pct": 22.93,
      "median_return_pct": 17.26
    },
    "mc_quality": {
      "drift_error_pct": 19.25,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "expected_return_pct": 45.48,
      "median_return_pct": 26.85
    },
    "mc_quality": {
      "drift_error_pct": 31.63,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "p75": 200.35,
      "p95": 252.19,
      "prob_above_current": 69.0,
      "prob_20pct_drawdown": 7.0,
      "expected_return_pct": 15.84,
      "median_return_pct": 12.69
    },
    "mc_quality": {
      "drift_error_pct": 19.37,
      "drift_accurate": false
    },
    "statistics": {
