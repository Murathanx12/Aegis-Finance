...
```json
{
  "vix_term_structure": {
    ...
    "vix_level": "normal",
    "vix9d_vix_ratio": 0.926
  },
  "options_SPY": {
    "iv_skew": 1.315,
    "put_call_ratio": 1.135,
    "iv_rank": 1.2,
    "signal_score": 0.0,
...
{
  "cycle": 56,
  "timestamp": "2026-04-15T03:31:35.565985",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "current_price": 6967.31005859375,
  "final_mean": 9785.520073998818,
  "final_median": 8921.101717648738,
  "final_p05": 3892.608972113151,
  "final_p10": 4781.657209202861,
  "final_p25": 6494.241222430237,
  "final_p75": 12166.840526938837,
  "final_p90": 15944.849925271365,
  "final_p95": 18754.328053700337,
  "total_return_pct": 40.44903975428764,
  "annual_return_pct": 7.029563651902926,
  "crash_prob_1y": 25.77,
  "crash_prob_5y": 82.16,
  "cvar_95_pct": -55.064143879881165,
  "max_dd_pct": -30.75104530400099,
  "max_drawdown_pct": 30.75104530400099
}
```
...
```json
{
  "ABBV": {
    "ticker": "ABBV",
    "current_price": 209.5399932861328,
    "mc_median_5y": 95.40149663885755,
    "mc_p10_5y": 7.166172656889924,
    "mc_p90_5y": 260.8747491689483,
    "garch_vol": 23.205834306923684,
    "garch_nu": 8.0,
    "crash_prob_3m": 2.15,
    "signal_action": "Buy",
    "signal_score": 0.277,
  ...
  "AAPL": {
    "ticker": "AAPL",
    "current_price": 258.510009765625,
    "mc_median_5y": 72.15598746471943,
    "mc_p10_5y": -13.822034667691662,
    "mc_p90_5y": 231.98467343378962,
    "garch_vol": 22.901023492879542,
    "garch_nu": 8.0,
    "crash_prob_3m": 4.02,
    "signal_action": "Buy",
    "signal_score": 0.221,
  ...
  "HD": {
    "ticker": "HD",
    "current_price": 341.9200134277344,
    "mc_median_5y": 50.415586420721056,
    "mc_p10_5y": -24.204652233566605,
    "mc_p90_5y": 189.4462017334697,
    "garch_vol": 25.834273748508025,
    "garch_nu": 8.0,
    "crash_prob_3m": 3.82,
    "signal_action": "Hold",
    "signal_score": 0.02,
  ...
  "UNH": {
    "ticker": "UNH",
    "current_price": 315.3399963378906,
    "mc_median_5y": 17.38137230385959,
    "mc_p10_5y": -49.99430137017161,
    "mc_p90_5y": 165.07172198557285,
    "garch_vol": 36.93335139020333,
    "garch_nu
... [truncated]
```
...
1. Experiment report: lab/experiments/cycle_056/experiment_report.json
   {
     "cycle": 56,
...
2. Commit: `git add -A && git commit -m "Lab cycle_056: <summary>"`
