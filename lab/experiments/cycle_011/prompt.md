# Aegis Finance - Autonomous R&D Lab - Cycle 11
Time: 2026-04-11T22:37:38.005805
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_011: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_011/data_test --cycle 11`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_011/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_011: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.22,
      "direction_correct": false,
      "absolute_error_pct": 15.93
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.11,
      "direction_correct": true,
      "absolute_error_pct": 4.49
    },
    {
      "test_start": "2025-10-09",
      "horizon_days": 63,
      "actual_return_pct": 3.43,
      "mc_median_return_pct": 4.34,
      "direction_correct": true,
      "absolute_error_pct": 0.91
    }
  ],
  "summary": {
    "n_tests": 3,
    "direction_accuracy_pct": 66.7,
    "mean_absolute_error_pct": 7.11
  }
}
```
...
{
  "cycle": 11,
  "timestamp": "2026-04-11T22:37:12.961539",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7404.56,
    "mean_price": 7516.76,
    "p5": 5640.54,
    "p95": 9855.37,
    "prob_positive": 68.3,
    "prob_20pct_crash": 3.3,
    "expected_annual_return_pct": 10.27
  },
  "3y": {
    "median_price": 8816.28,
    "mean_price": 9210.05,
    "p5": 5460.67,
    "p95": 14280.5,
    "prob_positive": 80.7,
  ...
  "5y": {
    "median_price": 10450.26,
    "mean_price": 11293.54,
    "p5": 5727.09,
    "p95": 19539.79,
    "prob_positive": 87.4,
    "prob_20pct_crash": 3.9,
    "expected_annual_return_pct": 10.62
  },
  "quality_check": {
    "theoretical_1y_drift": 0.10072,
    "actual_1y_mean_log_return": 0.08272,
    "drift_error_pct": 17.87,
    "variance_ratio": 1.019
  }
}
```
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "p75": 371.77,
      "p95": 483.65,
      "prob_above_current": 73.6,
      "prob_20pct_drawdown": 6.7,
      "expected_return_pct": 23.23,
      "median_return_pct": 18.64
    },
    "mc_quality": {
      "drift_error_pct": 16.61,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "prob_20pct_drawdown": 18.0,
      "expected_return_pct": 46.65,
      "median_return_pct": 29.52
    },
    "mc_quality": {
      "drift_error_pct": 29.99,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "expected_return_pct": 14.49,
      "median_return_pct": 11.12
    },
    "mc_quality": {
      "drift_error_pct": 26.02,
      "drift_accurate": false
    },
    "statistics": {
