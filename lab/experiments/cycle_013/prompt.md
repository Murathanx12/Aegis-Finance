# Aegis Finance - Autonomous R&D Lab - Cycle 13
Time: 2026-04-11T22:54:20.770867
...
5. **Commit your changes** at the end:
   `git add -A && git commit -m "Lab cycle_013: <summary>"`
...
- Re-run the data generator to see if output improved:
  `python lab/data_generator.py --output-dir lab/experiments/cycle_013/data_test --cycle 13`

### Step 4: Write the experiment report

CRITICAL - You MUST create this file before finishing:
lab/experiments/cycle_013/experiment_report.json
...
### Step 5: Commit
git add -A
git commit -m "Lab cycle_013: <summary>"
  ...
  "tests": [
    {
      ...
      "mc_median_return_pct": -1.46,
      "direction_correct": false,
      "absolute_error_pct": 16.17
    },
    {
      "test_start": "2025-07-11",
      "horizon_days": 63,
      "actual_return_pct": 7.59,
      "mc_median_return_pct": 3.22,
      "direction_correct": true,
      "absolute_error_pct": 4.38
    },
    {
...
{
  "cycle": 13,
  "timestamp": "2026-04-11T22:53:53.323892",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_monte_carlo",
...
```json
{
  "start_price": 6816.89,
  "1y": {
    "median_price": 7406.87,
    "mean_price": 7494.7,
    "p5": 5634.05,
    "p95": 9714.33,
    "prob_positive": 68.1,
    "prob_20pct_crash": 3.2,
    "expected_annual_return_pct": 9.94
  },
  "3y": {
    "median_price": 8845.17,
    "mean_price": 9213.2,
    "p5": 5385.67,
    "p95": 14304.29,
    "prob_positive": 81.8,
    "prob_20pct_crash": 5.4,
    "expected_annual_return_pct": 10.56
  },
  "5y": {
    "median_price": 10357.4,
    "mean_price": 11273.58,
    "p5": 5640.77,
    "p95": 19946.91,
    "prob_positive": 87.2,
  ...
  "quality_check": {
    ...
    "actual_1y_mean_log_return": 0.08938,
    "drift_error_pct": 11.26,
    "variance_ratio": 0.99
  }
}
```
...
```json
{
  "AAPL": {
    ...
    "monte_carlo": {
      ...
      "prob_20pct_drawdown": 7.6,
      "expected_return_pct": 22.65,
      "median_return_pct": 16.86
    },
    "mc_quality": {
      "drift_error_pct": 20.94,
  ...
  "NVDA": {
    ...
    "monte_carlo": {
      ...
      "prob_20pct_drawdown": 15.3,
      "expected_return_pct": 49.08,
      "median_return_pct": 34.62
    },
    "mc_quality": {
      "drift_error_pct": 25.29,
      "drift_accurate": false
    },
    "statistics": {
  ...
  "XOM": {
    ...
    "monte_carlo": {
      ...
      "median_return_pct": 13.18
    },
    "mc_quality": {
      "drift_error_pct": 21.09,
      "drift_accurate": false
    },
    "statistics": {
