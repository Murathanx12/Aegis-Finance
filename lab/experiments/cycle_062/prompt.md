# Aegis Finance — R&D Cycle 62 (INTEGRATE)
...
```json
{
  "vix_term_structure": {
    "values": {
      "VIX": 18.549999237060547,
      "VIX3M": 21.18000030517578,
      "VIX9D": 16.709999084472656
    },
    "vix_vix3m_ratio": 0.876,
    "contango": true,
    "backwardation": false,
    "structure": "normal_contango",
    "signal": "neutral",
    "interpretation": "Normal term structure: VIX (18.5) < VIX3M (21.2)",
    "vix_level": "normal",
    "vix9d_vix_ratio": 0.901
  },
  "options_SPY": {
    "iv_skew": 1.442,
    "put_call_ratio": 1.891,
    "iv_rank": 13.0,
    "signal_score": 0.15,
    "signal_sentiment": "slightly_bullish"
  },
  "options_AAPL": {
    "iv_skew": 2.26,
    "put_call_ratio": 0.416,
    "iv_rank": 41.3,
    "signal_score": -0.25,
...
{
  "cycle": 62,
  "timestamp": "2026-04-17T01:48:53.451186",
  "data_sources": [
    "market_snapshot",
    "stock_analysis",
    "sp500_mc",
...
```json
{
  ...
  "current_price": 7038.41015625,
  "final_mean": 9871.153336162668,
  "final_median": 8982.347712908228,
  "final_p05": 3971.410471112984,
  "final_p10": 4822.417599398818,
  "final_p25": 6551.203740667559,
  "final_p75": 12199.978339753612,
  "final_p90": 16043.848669585019,
  "final_p95": 18904.269671493366,
  "total_return_pct": 40.24691822481012,
  "annual_return_pct": 6.998740453972663,
  "crash_prob_1y": 25.05,
  "crash_prob_5y": 81.36,
  "cvar_95_pct": -54.16778482913456,
  "max_dd_pct": -30.65404175185915,
  "max_drawdown_pct": 30.65404175185915
}
```
...
```json
{
  "META": {
    "ticker": "META",
    "current_price": 676.6099853515625,
    "mc_median_5y": 50.92257626786649,
    "mc_p10_5y": -48.64369591865444,
    "mc_p90_5y": 300.0,
    "garch_vol": 40.44253075859804,
    "garch_nu": 8.0,
    "crash_prob_3m": 5.84,
    "signal_action": "Buy",
    "signal_score": 0.392,
  ...
  "NVDA": {
    "ticker": "NVDA",
    "current_price": 198.63999938964844,
    "mc_median_5y": 65.17721709824032,
    "mc_p10_5y": -57.42219352512022,
    "mc_p90_5y": 300.0,
    "garch_vol": 37.41203346881911,
    "garch_nu": 8.0,
    "crash_prob_3m": 7.99,
  ...
  "BRK-B": {
    "ticker": "BRK-B",
    "current_price": 472.5,
    "mc_median_5y": 32.89474707823472,
    "mc_p10_5y": -14.45746466585005,
    "mc_p90_5y": 108.57018918766576,
    "garch_vol": 14.931723542745537,
    "garch_nu": 8.0,
    "crash_prob_3m": 2.72,
    "signal_action": "Hold",
    "signal_score": 0.014,
  ...
  "PG": {
    "ticker": "PG",
    "current_price": 142.85499572753906,
    "mc_median_5y": 21.209309482450767,
    "mc_p10_5y": -30.530569566950017,
    "mc_p90_5y": 103.87144734052387,
    "garch_vol": 19.37059023734512,
    "garch_nu": 8.0,
...
1. Write experiment report to: lab/experiments/cycle_062/experiment_report.json
   {
     "cycle": 62,
...
2. Commit: `git add -A && git commit -m "Lab cycle_062: <summary>"`
