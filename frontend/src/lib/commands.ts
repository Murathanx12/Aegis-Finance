...
export const COMMANDS: CommandDef[] = [
  ...
  },
  {
    code: "NAV",
    label: "Track Record",
    description: "Live forward paper-lane NAV vs SPY/AGG/60-40",
    href: "/portfolio-intelligence/track-record",
    aliases: ["TRACK", "RECORD", "LANES"],
    keywords: ["track record", "nav", "paper", "lanes", "performance"],
  },
  {
    code: "CONV",
    label: "Conviction",
    description: "Log buy/sell decisions into the immutable record",
    href: "/portfolio-intelligence/conviction",
    aliases: ["CONVICTION", "DECISIONS"],
    keywords: ["conviction", "decisions", "journal"],
  },
  {
    code: "RISK",
    label: "Risk Watch",
    description: "Structural fragility composite, candidates, alerts",
    href: "/portfolio-intelligence/risk-watch",
    aliases: ["FRAGILITY", "WATCH"],
    keywords: ["fragility", "risk watch", "alerts"],
  },
  {
    code: "DEV",
    label: "Dev Dashboard",
    description: "Deploy health, lanes, registry, warnings",
    href: "/dev",
    aliases: ["DEV", "OPS"],
    keywords: ["dev", "health", "registry", "operator"],
  },
  {
    code: "COPILOT",
    label: "Copilot",
